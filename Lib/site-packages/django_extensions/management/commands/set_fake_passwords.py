...
DEFAULT_FAKE_ = 'password'


class Command(BaseCommand):
    help = 'DEBUG only: sets all user passwords to a common value ("%s" by default)' % (DEFAULT_FAKE_, )
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            '--password', dest='default_passwd', default=DEFAULT_FAKE_,
    ...
    def handle(self, *args, **options):
        ...
        if options.get('prompt_passwd', False):
            ...
            passwd = options.get('default_passwd', DEFAULT_FAKE_)
